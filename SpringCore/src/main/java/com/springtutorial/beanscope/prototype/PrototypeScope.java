package com.springtutorial.beanscope.prototype;
...
public class PrototypeScope {
	...
	public static void main(String[] args) {
		ApplicationContext context = new ClassPathXmlApplicationContext("com/springtutorial/beanscope/prototype/config.xml");
